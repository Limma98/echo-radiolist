...
AddEventHandler("playerDropped", function()
    ...
    for _, p in pairs(list) do
        TriggerClientEvent("echo-radiolist:Client:SyncRadioChannelPlayers", p.Source, src, 0, list)
    end
...
function connect(src, oldCh, newCh)
    ...
    for _, p in pairs(list) do
        TriggerClientEvent("echo-radiolist:Client:SyncRadioChannelPlayers", p.Source, src, newCh, list)
    end
end
...
function disconnect(src, ch)
    ...
    TriggerClientEvent("echo-radiolist:Client:SyncRadioChannelPlayers", src, src, 0, list)
